...
<div id="page-top" class="p-5  d-flex justify-content-center secondary-header <?php echo $contact_page == 'contact.php' ? 'mb-0' : null ?>" style="<?php echo $currentUrl[3] !== 'blog' ? 'margin-bottom: 5rem;' : null?>
